...
namespace AnalogGameEngine.Entities {
    ...
    /// </summary>
    public class Card<T> : ICard where T : CardType {
        public T Type { get; private set; }

        private CardCollectionBase collection;
        ...
        public void moveTo(CardCollectionBase collection) { this.moveTo(collection, 0); }
